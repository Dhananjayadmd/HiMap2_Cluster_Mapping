...
def main(dfg_xml, no_clusters, affinity_, no_init,number_of_cluster_rows_in_cgra,max_no_clusters):
    ...
    # Cluster
    for n in range(int(no_clusters),int(max_no_clusters)):
        print('no_clusters affinity no_init')
        print(n, affinity_, no_init)
        print('spectral dfg clustering')
        scdfg = SpectralClustering(int(n), affinity=str(affinity_), n_init=int(no_init))
...
if __name__ == '__main__':
    ...
    max_no_clusters = sys.argv[6]
    main(dfg_xml, no_clusters, affinity_, no_init,number_of_cluster_rows_in_cgra,max_no_clusters)
